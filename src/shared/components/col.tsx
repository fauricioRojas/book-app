...
const StyledCol = styled.div<StyledColProps>`
  ...
  margin-left: ${({ $offset }) =>
    $offset ? `${COL_WIDTH * $offset}%` : undefined};
  ...
  ${({ theme }) => theme.breakpoints.xxl} {
    ...
    margin-left: ${({ $offsetXxl }) =>
      $offsetXxl ? `${COL_WIDTH * $offsetXxl}%` : undefined};
