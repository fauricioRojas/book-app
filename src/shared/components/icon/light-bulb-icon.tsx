...
export const LightBulbIcon: FC<CommonIconProps> = ({
  ...
  >
    <g transform="translate(-204.5 -1608.362)">
      <rect width="10" height="6" x="215.5" y="1630.362" fill={color} />
      <path fill="none" stroke={color} d="M218.5 1636.362v2m4-2v2" />
      <path
        fill={color}
      ...
      />
      <path fill="none" stroke={color} d="M210.5 1630.862h20" />
      <path
        fill="none"
        stroke={color}
        strokeLinecap="round"
